...
void blu_analog_triggers_init(void)
{
    ...
    #if defined(CONFIG_BLUCONTROL_LEFT_TRIGGERS_ANALOG) || defined(CONFIG_BLUCONTROL_RIGHT_TRIGGERS_ANALOG)
    blu_analog_init();
    ...
    #ifdef CONFIG_BLUCONTROL_LEFT_TRIGGERS_ANALOG
    ...
    #endif
    #ifdef CONFIG_BLUCONTROL_RIGHT_TRIGGERS_ANALOG
