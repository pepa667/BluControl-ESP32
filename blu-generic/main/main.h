...
// Triggers
    ...
    #define TRIGGER_L_NUMBER CONFIG_BLUCONTROL_BUTTON_L_BTN
#else
    #define TRIGGER_L_NUMBER -1
#endif
#ifdef CONFIG_BLUCONTROL_BUTTON_ZL_BTN
    #define TRIGGER_ZL_NUMBER CONFIG_BLUCONTROL_BUTTON_ZL_BTN
#else
    #define TRIGGER_ZL_NUMBER -1
#endif
#ifdef CONFIG_BLUCONTROL_BUTTON_R_BTN
    #define TRIGGER_R_NUMBER CONFIG_BLUCONTROL_BUTTON_R_BTN
#else
    #define TRIGGER_R_NUMBER -1
#endif
#ifdef CONFIG_BLUCONTROL_BUTTON_ZR_BTN
    #define TRIGGER_ZR_NUMBER CONFIG_BLUCONTROL_BUTTON_ZR_BTN
#else
    #define TRIGGER_ZR_NUMBER -1
#endif
